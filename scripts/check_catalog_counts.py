...
def main() -> int:
    ...
    checks = [
        (
            ROOT / "README.md",
            r"\| \*\*\[Instructions 一覧\]\(docs/instructions\.md\)\*\* \| [^\n]+ \| ([0-9]+ 件) \|",
            "README の Instructions",
            f"{counts['instructions']} 件",
        ),
        (
            ROOT / "README.md",
            r"\| \*\*\[Agents 一覧\]\(docs/agents\.md\)\*\* \| [^\n]+ \| ([0-9]+ 件) \|",
            "README の Agents",
            f"{counts['agents']} 件",
        ),
        (
            ROOT / "README.md",
            r"\| \*\*\[Prompts / Skills 一覧\]\(docs/prompts\.md\)\*\* \| [^\n]+ \| ([0-9]+ 件) \|",
