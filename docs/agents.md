...
> [github/awesome-copilot](https://github.com/github/awesome-copilot) で公開されている **188 個の Agents** を日本語で解説します。
...
Agents は **188 ファイル** あり、以下のカテゴリに分類されます：
...
| その他 | 約 14 | 専門エージェント、a11y、LinkedIn、TaxCore |
