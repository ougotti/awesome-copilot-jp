...
7 節・2 節で扱った Agent Finder / ARD が「Catalog に A2A エージェントも含められる」としているのは、この位置づけと整合します（[7-2 節](#7-2-agent-finder--ard--必要な時に見つける)）。ARD が指す先のリソースの一部が、AAIF の下で統治される、という関係です。
